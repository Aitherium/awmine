...
interesting failures live BETWEEN them. "awmine is installed" is not the useful
fact -- "awmine is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awmine needs at runtime, and a
